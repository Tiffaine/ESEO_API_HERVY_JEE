...
<body>
	...
	<input type="hidden" id="ville1_session" value=<%=ville1%> />
	<input type="hidden" id="ville2_session" value=<%=ville2%> />
	Ville 1 : <%=ville1%> 
	Ville 2 : <%=ville2%> <br>

	Ville 1 : <span id="ville1id"></span><br>
	Latitude 1 :<span id="ville1latitude"></span><br>
	Longitude 1 :<span id="ville1longitude"></span><br>
	
	Ville 2 : <span id="ville2id"></span><br>
	Latitude 2 :<span id="ville2latitude"></span><br>
	Longitude 2 :<span id="ville2longitude"></span><br>
	...
	<input type="submit" name="calculerLaDistance"/>
	</form>
